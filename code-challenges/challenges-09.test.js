...
const addPurchases = (arr) => {
  // Solution code here...
  let val = arr.reduce((hi, value) => {hi += value.purchasePrice; return hi; }, 0);
  return val;
};
